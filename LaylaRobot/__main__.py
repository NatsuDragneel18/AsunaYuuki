...
PM_START_TEXT = """
Hello there,My name's [Yuuki Asuna](https://telegra.ph/file/877e80353c3b5c3890089.jpg)
I am an 𝐴𝑛𝑖𝑚𝑒 Themed Group Managing Bot, ʜɪᴛ` /help to see my command.
Maintained by [Yoga Pranata](https://t.me/Yoga_CIC) ❤
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/asunalogs"),
        InlineKeyboardButton(
...
Powered by :- [xSpreadNetworkSx](t.me/SpreadNetworks)"""

layla_IMG = "https://telegra.ph/file/877e80353c3b5c3890089.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [xSpreadNetworkSx](t.me/SpreadNetworks) \
 Supporting isnt always financial! [xSpreadNetworkSx](t.me/SpreadNetworks) \
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Asuna*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Awesome Bots @SpreadNetworks
                 \n❍ Support Group @YuukiAsunaSupportChat
                 \n❍ Assistant @BlueDragonExorcist.
                 \nHere is the [💾Repository](https://notreleasedyet.com).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Asuna*
                 \nHere is the [Source Code](https://notreleasedyet.com) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
